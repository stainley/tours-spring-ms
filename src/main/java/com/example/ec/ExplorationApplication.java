...
import static com.example.ec.ExplorationApplication.TourFromFile.importTours;
...
public class ExplorationApplication implements CommandLineRunner {
    ...
    @Autowired
    public ExplorationApplication(TourPackageService tourPackageService, TourService tourService) {
